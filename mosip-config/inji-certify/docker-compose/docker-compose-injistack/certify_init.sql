...
VALUES (
    ...
    '',  -- the VC template from the JSON
    ...
    'did:web:ilyassr01zz.github.io:medaxis-did:certify',  -- did_url
    ...
    '{"fullName": {"display": [{"name": "Full Name", "locale": "en"}]}, "mobileNumber": {"display": [{"name": "Mobile Number", "locale": "en"}]}, "dateOfBirth": {"display": [{"name": "Date of Birth", "locale": "en"}]}, "gender": {"display": [{"name": "Gender", "locale": "en"}]}, "state": {"display": [{"name": "State", "locale": "en"}]}, "district": {"display": [{"name": "District", "locale": "en"}]}, "villageOrTown": {"display": [{"name": "Village or Town", "locale": "en"}]}, "postalCode": {"display": [{"name": "Postal Code", "locale": "en"}]}, "landArea": {"display": [{"name": "Land Area", "locale": "en"}]}, "landOwnershipType": {"display": [{"name": "Land Ownership Type", "locale": "en"}]}, "primaryCropType": {"display": [{"name": "Primary Crop Type", "locale": "en"}]}, "secondaryCropType": {"display": [{"name": "Secondary Crop Type", "locale": "en"}]}, "farmerID": {"display": [{"name": "Farmer ID", "locale": "en"}]}}'::JSONB,  -- credential_subject
    ...
    '[{"Full Name": "${fullName}", "Mobile Number": "${mobileNumber}", "Date Of Birth": "${dateOfBirth}", "Gender": "${gender}", "State": "${state}", "District": "${district}", "Village or Town": "${villageOrTown}", "Postal Code": "${postalCode}", "Land Area": "${landArea}", "Land Ownership Type": "${landOwnershipType}", "Primary Crop Type": "${primaryCropType}", "Secondary Crop Type": "${secondaryCropType}", "Farmer ID": "${farmerID}"}]'::JSONB,  -- qr_settings (optional)
...
INSERT INTO certify.credential_config (
    ...
    key_manager_ref_id, signature_algo, signature_crypto_suite, sd_claim,
    display, display_order, scope, cryptographic_binding_methods_supported,
    credential_signing_alg_values_supported, proof_types_supported,
    credential_subject, mso_mdoc_claims, plugin_configurations,
    ...
    'active',
    '',
    NULL, NULL,
    'https://www.w3.org/2018/credentials/v1,https://ilyassr01zz.github.io/medaxis-did/contexts/prescription.json,https://w3id.org/security/suites/ed25519-2020/v1',
    'PrescriptionCredential,VerifiableCredential',
    'ldp_vc',
    'did:web:ilyassr01zz.github.io:medaxis-did:certify',
    'CERTIFY_VC_SIGN_ED25519', 'ED25519_SIGN', 'EdDSA', 'Ed25519Signature2020',
    NULL,
    '[{"name": "MedAxis Prescription", "locale": "en", "logo": {"url": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png", "alt_text": "MedAxis Logo"}, "background_color": "#0D7C7C", "text_color": "#FFFFFF", "background_image": {"uri": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png"}}]'::JSONB,
    ARRAY['prescriptionId','medication','dosage','doctorName','patientCNIE','expiryDate','status'],
    'mock_identity_vc_ldp',
    ARRAY['did:jwk'],
    ARRAY['Ed25519Signature2020'],
    '{"jwt": {"proof_signing_alg_values_supported": ["RS256", "ES256"]}}'::JSONB,
    '{"prescriptionId": {"display": [{"name": "Prescription ID", "locale": "en"}]}, "medication": {"display": [{"name": "Medication", "locale": "en"}]}, "dosage": {"display": [{"name": "Dosage", "locale": "en"}]}, "doctorName": {"display": [{"name": "Doctor", "locale": "en"}]}, "status": {"display": [{"name": "Status", "locale": "en"}]}}'::JSONB,
    NULL,
    '[{"mosip.certify.mock.data-provider.csv.identifier-column": "id", "mosip.certify.mock.data-provider.csv.data-columns": "id,prescriptionId,medication,dosage,doctorName,patientCNIE,expiryDate,status", "mosip.certify.mock.data-provider.csv-registry-uri": "/home/mosip/config/prescription_data.csv"}]'::JSONB,
    ARRAY['revocation'],
    '[{"Prescription ID": "${prescriptionId}", "Medication": "${medication}", "Doctor": "${doctorName}"}]'::JSONB,
    'EdDSA', NOW(), NULL
);